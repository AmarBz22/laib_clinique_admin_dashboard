...
const Header = ({ toggleSidebar, isSidebarOpen }) => {
  return (
    <header
      className={`${isSidebarOpen ? 'responsive-div ': 'w-full'} z-20 flex items-center  justify-between p-4 w- bg-white shadow-md h-20 fixed top-0 right-0 transition-all duration-300`}
